...
<script>
  export default {
  //  in VueJS data come frome v-model in the form
    data() {
      return {
        name: '',
        email: '',
    ...
    methods: {
	//  in VueJS register() come frome @submit.prevent="register" in the form
      register() {
        var app = this
        this.$auth.register({
          data: {
          ...
          success: function () {  // if Register success login page open by push in router
            app.success = true
